...
public class Bateau extends Pion{
    ...
    public String deplacer(int destination_i, int destination_j)
    {
        ...
        if(this.bateau_est_vide()==0)
        {
            ...
            {
                if(this.getCouleur()== modele.Type_couleur.BLEU)
                {
                    bleu++;
                }
                else if(this.getCouleur()== modele.Type_couleur.ROUGE)
                {
                    rouge++;
                }
                else if(this.getCouleur()== modele.Type_couleur.VERT)
                {
                    vert++;
                }
                else if(this.getCouleur()== modele.Type_couleur.JAUNE)
                {
                    jaune++;
                }
            }
            ...
            else
            {
                ...
                modele.Type_couleur couleur_majoritaire=null;

                if(Collections.max(couleurs_a_bord)==bleu)
                {
                    couleur_majoritaire= modele.Type_couleur.BLEU;
                }
                else if(Collections.max(couleurs_a_bord)==jaune)
                {
                    couleur_majoritaire= modele.Type_couleur.JAUNE;
                }
                if(Collections.max(couleurs_a_bord)==vert)
                {
                    couleur_majoritaire= modele.Type_couleur.VERT;
                }
                if(Collections.max(couleurs_a_bord)==rouge)
                {
                    couleur_majoritaire= modele.Type_couleur.ROUGE;
                }
                modele.Type_couleur couleur_joueur_actif=this.getCouleur();
